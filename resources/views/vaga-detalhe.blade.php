...
<main>
    <div class="container mt-3 mb-3" style="max-width: 720px;">
        <div class="row">
            <div class="col-6 pb-5"><button class="btn btn-{{ $inscrito ? 'success' : 'primary' }} w-50" @disabled($inscrito)  data-bs-toggle="modal" data-bs-target="#confirmModal">@if(!$inscrito)Inscrever @else Inscrito @endif</button></div>
